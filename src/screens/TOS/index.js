        ...
        <ImageBackground source={bg} style={globalStyles.background}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollViewsContainer}>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.contentContainer, styles.noBottomBorder]}>
              ...
              <View style={styles.listContainer}>
                <View style={styles.listRow}>
                  ...
                  <Text style={styles.regularText}>
                    our website at <Text style={styles.blueInnerText} onPress={() => Communications.web("https://thrivesavings.com")}>thrivesavings.com</Text> and all of our other websites to which these Terms are posted (collectively, the “Website”);
                  </Text>
                </View>
                <View style={styles.listRow}>
              ...
              <Text style={styles.regularText}>
                Your use of and access to the Services are subject at all times to these Terms and our <Text style={styles.blueInnerText} onPress={() => navigation.navigate("PP")}>Privacy Policy</Text>. Please read these Terms and our <Text style={styles.blueInnerText} onPress={() => navigation.navigate("PP")}>Privacy Policy</Text> carefully.
                {"\n\n"}
                By using or accessing the Services or by clicking to agree to these Terms when that option is made available to you, you represent that you have read and understand these Terms and our <Text style={styles.blueInnerText} onPress={() => navigation.navigate("PP")}>Privacy Policy</Text> and you agree to be bound by these Terms and our <Text style={styles.blueInnerText} onPress={() => navigation.navigate("PP")}>Privacy Policy</Text> which describes the collection, use, disclosure and safeguarding of my personal information by Thrive. If you do not agree to all the terms and conditions of these Terms and our Privacy Policy, do not use or access the Services.
                {"\n\n"}
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.contentContainer, styles.noTopBorder, styles.noBottomBorder]}>
              ...
              <Text style={styles.regularText}>
                ...
                {"\n\n"}
                The following is a summary of the key terms of the PAD Agreement (the complete agreement is available <Text style={styles.blueInnerText} onPress={() => Communications.web("https://drive.google.com/file/d/1INmKytEdpUugnUyF4RZf1or_Xr0UHJfG/view?usp=sharing")}>here</Text> and the complete PAD Agreement is incorporated by reference into these Terms and forms part of these Terms):
                {"\n\n"}
              ...
              <Text style={[styles.regularText]}>
                Thrive does not charge fees to end users for use of the Services. Your employer, work provider, or affiliated organization may pay a subscription access fee to Thrive to enable you to use the Thrive Services.
                {"\n\n"}
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.contentContainer, styles.noTopBorder, styles.noBottomBorder]}>
              <Text style={styles.regularText}>
                ...
                {"\n\n"}
                You can unsubscribe at any time by using the unsubscribe links provided in these electronic communications or by contacting Thrive Savings Inc. at <Text style={styles.blueInnerText} onPress={() => Communications.email(["help@thrivesavings.com"],null,null,"Help Needed",null)}>help@thrivesavings.com</Text>. If you withdraw your consent to receive information relating to third-party products or services electronically, we may still be obligated by law to send you updates on your account by email.
                {"\n\n"}
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.contentContainer, styles.noTopBorder, styles.noBottomBorder]}>
              ...
              <Text style={styles.regularText}>
                If your mobile device is lost or stolen or if you suspect someone has gained unauthorized access to your username or password, you must contact us immediately at <Text style={styles.blueInnerText} onPress={() => Communications.email(["help@thrivesavings.com"],null,null,"Help Needed",null)}>help@thrivesavings.com</Text>. In order to take any action, you will need to provide certain User Information so we can verify your identity.
              </Text>
              ...
              <View style={styles.listContainer}>
                ...
                <View style={styles.listRow}>
                  ...
                  <Text style={styles.regularText}>
                    ...
                    {"\n\n"}
                    Telephone Number: <Text onPress={() => Communications.phonecall("8332433223", true)}>1-833-243-3223</Text>
                    {"\n\n"}
                    Email Address: <Text style={styles.blueInnerText} onPress={() => Communications.email(["help@thrivesavings.com"],null,null,"Help Needed",null)}>help@thrivesavings.com</Text>
                  </Text>
                </View>
                <View style={styles.listRow}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.contentContainer, styles.noTopBorder]}>
              ...
              <Text style={styles.regularText}>
                If you have any questions, comments, or concerns regarding these Terms or the Services, please contact us at <Text style={styles.blueInnerText} onPress={() => Communications.email(["help@thrivesavings.com"],null,null,"Help Needed",null)}>help@thrivesavings.com</Text>, or Thrive Savings Inc., 10 Dundas Street East, 6th Floor, Toronto, ON M5B 2G9.
                {"\n\n"}
                <Text style={styles.boldText}>
